...
if node[:instance_role] == 'solo'
  ...
  execute "scp -i /home/deploy/.ssh/tunnel/data/homeview/current/db/backups/msc_latest.sql.bz2 deploy@employeehomeview.com:/data/homeviw/current/db/backups/msc_latest.sql.bz2"
